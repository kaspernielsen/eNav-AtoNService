...
class DatasetServiceTest {
    ...
    void testReplace() {
        ...
        doReturn(this.newDatasetContent).when(this.datasetContentService).replace(any());
        ...
        assertEquals(this.newDataset.getDatasetIdentificationInformation().getDatasetAbstract(), result.getDatasetIdentificationInformation().getDatasetAbstract());
        assertNotNull(result.getDatasetContent());
        assertEquals(this.newDatasetContent.getId(), result.getDatasetContent().getId());
        assertEquals(this.newDatasetContent.getSequenceNo(), result.getDatasetContent().getSequenceNo());
        assertEquals(this.newDatasetContent.getContent(), result.getDatasetContent().getContent());
        assertEquals(this.newDatasetContent.getDeltaLength(), result.getDatasetContent().getDeltaLength());
        assertEquals(this.newDatasetContent.getDelta(), result.getDatasetContent().getDelta());
        assertEquals(this.newDatasetContent.getDeltaLength(), result.getDatasetContent().getDeltaLength());
        assertFalse(result.getCancelled());
    }
