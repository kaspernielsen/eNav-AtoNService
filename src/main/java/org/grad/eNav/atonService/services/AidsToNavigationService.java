...
@Service
@Slf4j
public class AidsToNavigationService implements MessageHandler {
    ...
    @PostConstruct
    public void init() {
        log.info("Aids to Navigation Service is booting up...");
    ...
    @PreDestroy
    public void destroy() {
        log.info("Aids to Navigation Service is shutting down...");
    ...
    public void handleMessage(Message<?> message) throws MessagingException {
        ...
        // String input usually come from the S-125 deletions
            ...
            this.deleteByAtonNumber(payload);
        }
        else {
